...
int main() {
    ...
    myObj.y = 50;  // Not allowed (private) Cause Error
    return 0;
}
...
This is also the main ingredient of the Encapsulation concept, which you will learn more about in the next chapter.
